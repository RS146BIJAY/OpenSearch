...
public class CompositeIndexWriterTests extends OpenSearchTestCase {
...
//                    compositeIndexWriter.addDocuments(doc.docs(), operation.uid());
//                    if (rarely()) {
//                        compositeIndexWriter.deleteDocument(operation.uid(), false, new Engine.Delete(operation.id(), operation.uid(), 1, 1, primaryTerm.get()));
...
//    }
    ...
    private IndexWriter createWriter() throws IOException {
        try {
            return new IndexWriter(store.directory(), newIndexWriterConfig());
    ...
    private CompositeIndexWriter.DisposableIndexWriter createChildWriterFactory(String criteria, CompositeIndexWriter.CriteriaBasedIndexWriterLookup lookup) throws IOException {
