...
public class CompositeIndexWriterTests extends OpenSearchTestCase {
        ...
        try {
            ...
            while (numOps > 0) {
                disposableIndexWriter = liveIndexWriterDeletesMap.get()
                    .computeIndexWriterIfAbsentForCriteria("200", this::createChildWriterUtil);
    ...
    public void testConcurrentIndexingDuringRefresh() throws IOException, InterruptedException {
        CompositeIndexWriter compositeIndexWriter = new CompositeIndexWriter(config(), createWriter(), this::createChildWriterUtil, softDeletesField);
        AtomicBoolean run = new AtomicBoolean(true);
